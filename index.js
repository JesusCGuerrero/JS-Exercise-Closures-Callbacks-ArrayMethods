...
function processDuplicateFree(list, callback) {
  ...
  let unique_array = Array.from(new Set(list))
  return unique_array
}
...
function getFullNames(/* CODE HERE */runners) {
  /* CODE HERE */
    ...
    runners.forEach(function (items) {
      return newArr.push(`${items.last_name}, ${items.first_name}`);
    });
    return newArr;
  }
...
function firstNamesAllCaps(/* CODE HERE */runners) {
  /* CODE HERE */
  let newArr = runners.map(function(items){
...
function getRunnersByTShirtSize(/* CODE HERE */runners, tShirtSize) {
  /* CODE HERE */
  let newArr = runners.filter(function(item){
